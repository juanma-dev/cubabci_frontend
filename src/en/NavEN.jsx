    ...
    return (
        <>
            {isSidebarOpen && (<div className="sidebar">
                ...
                <Link onClick={closeSidebar} to="/en">Home</Link>
                <Link onClick={closeSidebar} to="/diplomatics/en">Havana syndrome</Link>
                <Link onClick={closeSidebar} to="/articles/en">Articles</Link>
            </div >
            )}
            <div className="topnav es">
                ...
                <Link className="hideOnMobile" to="/en">Home</Link>
                <Link className="hideOnMobile" to="/diplomatics/en">Havana syndrome</Link>
                <Link className="hideOnMobile" to="/articles/en">Articles</Link>
